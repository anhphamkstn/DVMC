...
namespace IPCOREUS
{
	...
	public class US_V_GD_DAT_HANG_GD_LOG_DAT_HANG : US_Object
	{
		...
		public decimal dcID_LOG_DAT_HANG 
		{
			get
			{
				return CNull.RowNVLDecimal(pm_objDR, "ID_LOG_DAT_HANG", IPConstants.c_DefaultDecimal);
			}
			set	
			{
				pm_objDR["ID_LOG_DAT_HANG"] = value;
			}
		}

		public bool IsID_LOG_DAT_HANGNull()	{
			return pm_objDR.IsNull("ID_LOG_DAT_HANG");
		}

		public void SetID_LOG_DAT_HANGNull() {
			pm_objDR["ID_LOG_DAT_HANG"] = System.Convert.DBNull;
		}
