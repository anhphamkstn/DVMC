...
<p>Dear thầy/c&ocirc;!</p>

<p>DVMC th&ocirc;ng b&aacute;o cập nhật t&igrave;nh h&igrave;nh đơn h&agrave;ng MA_DON_HANG, nội dunng thay đổi&nbsp;đơn h&agrave;ng như sau:</p>
...
<table style="width:100%;border:1px solid;">
	<tbody>
		...
		<tr>
			<td colspan="4"><p style="font-family:arial; font-size:13px;padding-left:5px;font-weight:bold;margin-top:10px;">THOI_GIAN_MONG_MUON_SUA_XONG</p>
            <br />
		...
		<tr>
			<td colspan="4"><span style="font-family:arial; font-size:14px">PHAN_HOI_CUA_DVMC</span></td>
		</tr>
	</tbody>
</table>
<p></p>
...
<div>Mời thầy/c&ocirc; đ&aacute;nh gi&aacute; đơn h&agrave;ng MA_DON_HANG&nbsp;<a href="LINK_DANH_GIA_DON_HANG" style="line-height: 20.7999992370605px;">tại đ&acirc;y</a></div>

<p>Cảm ơn thầy c&ocirc;!</p>