...
namespace TOSApp.App_Code
{
    ...
    public class SinhVien
    {
        ...
        public string Ho_Ten_QLHT { get; set; }
        public string Dien_thoai_QLHT { get; set; }
        ...
        public void get_sinh_vien_by_ds(DataSet ip_ds_sv)
        {
            if (ip_ds_sv.Tables[0].Rows.Count > 0)
            {
                ...
                if (ip_ds_sv.Tables[0].Rows[0][CSinhVien.HO_TEN_QLHT] != null 
                        && ip_ds_sv.Tables[0].Rows[0][CSinhVien.HO_TEN_QLHT] != "")
                    Ho_Ten_QLHT = ip_ds_sv.Tables[0].Rows[0][CSinhVien.HO_TEN_QLHT].ToString();
                if(ip_ds_sv.Tables[0].Rows[0][CSinhVien.DIEN_THOAI_QLHT] != null
                    && ip_ds_sv.Tables[0].Rows[0][CSinhVien.DIEN_THOAI_QLHT] != "")
                    Dien_thoai_QLHT = ip_ds_sv.Tables[0].Rows[0][CSinhVien.DIEN_THOAI_QLHT].ToString();
            }
        }
