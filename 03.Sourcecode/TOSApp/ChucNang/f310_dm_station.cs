///************************************************
/// Generated by: LinhDH
/// Date: 12/06/2014 11:42:24
/// Goal: Create Form for V_DM_STATION
///************************************************
...
namespace TOSApp
{
	public class f310_dm_station : System.Windows.Forms.Form
	{
		...
		DS_V_DM_STATION m_ds = new DS_V_DM_STATION();
		US_V_DM_STATION m_us = new US_V_DM_STATION();
		#endregion
		...
		private void grid2us_object(US_V_DM_STATION i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_V_DM_STATION i_us
			, int i_grid_row) {
		...
		private void insert_v_dm_station(){			
		//	f310_dm_station_DE v_fDE = new  f310_dm_station_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_v_dm_station(){
            m_us.hien_thi_stations();
            BaseMessages.MsgBox_Infor("Đã hiển thị các station thành công! Hãy thoát phần mềm ra và đăng nhập lại");
            this.Close();
		}
				
		private void delete_v_dm_station(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_V_DM_STATION v_us = new US_V_DM_STATION();
		...
		private void view_v_dm_station(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
...
//
		...
		//
		//
		private void f310_dm_station_Load(object sender, System.EventArgs e) {
			try{
