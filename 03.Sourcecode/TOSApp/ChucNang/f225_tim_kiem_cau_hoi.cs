...
namespace TOSApp
{
    public class f225_tim_kiem_cau_hoi : System.Windows.Forms.Form
    {
        ...
        private void set_define_events()
        {
            ...
            this.Load += new EventHandler(f225_tim_kiem_cau_hoi_Load);
            ...
            this.KeyDown += new KeyEventHandler(f225_tim_kiem_cau_hoi_KeyDown);
        ...
        void f225_tim_kiem_cau_hoi_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                switch (e.KeyCode)
